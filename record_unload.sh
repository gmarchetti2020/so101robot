lerobot-record \
    ...
    --teleop.id=daneel \
    --display_data=true \
    --dataset.repo_id=gimarchetti/sd101-unload-leo-3 \
    --dataset.episode_time_s=120 \
    --dataset.num_episodes=50 \
    --dataset.single_task="Pick up an item from the wooden block and put it in an empty container. Return to rest position." \
    --resume=true
