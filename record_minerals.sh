lerobot-record \
    ...
    --dataset.single_task="Pick the black tourmaline and put it in the green container. Pick the grey basalt and put it in the blue container. Return to rest position." \
    --resume=true
