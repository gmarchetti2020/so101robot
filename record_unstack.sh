lerobot-record \
    ...
    --teleop.id=daneel \
    --display_data=true \
    --dataset.repo_id=gimarchetti/sd101-unstack-leo-3 \
    --dataset.episode_time_s=120 \
    --dataset.num_episodes=50 \
    --dataset.single_task="Unstack the containers and place two to the right and two to the left of the robot arm. Return to rest position." \
    --resume=true
